...
CREATE TABLE funder_giving_history (
...
CREATE INDEX idx_giving_history_org    ON funder_giving_history(organization_id);
CREATE INDEX idx_giving_history_funder ON funder_giving_history(funder_id);
CREATE INDEX idx_giving_history_year   ON funder_giving_history(fiscal_year DESC);
