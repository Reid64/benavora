...
**Specification ID:** PIL-AGENT-BEN-INT-10  
**Version:** 1.0.0  
**Family:** intelligence  
**Default autonomy:** A2  
...
Identify permitted, professionally relevant contact channels and contact-governance state without private-data harvesting or converting discoverability into solicitation permission.
...
`BEN_INT_10Goal.v1` MUST include:
...
- **Channel Type And Provenance**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Business Versus Personal Channel**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Validity/Freshness**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Consent/Suppression State**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Role Relevance**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Contactability Uncertainty**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
...
- `BEN-QLF-05` when its canonical reasoning boundary is required; delegated work must use the current typed DelegatedTask contract and may not exceed inherited authority.
...
`BEN_INT_10Decision.v1` requires:
...
- `CHANNEL_TYPE_AND_PROVENANCE`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `BUSINESS_VERSUS_PERSONAL_CHANNEL`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `VALIDITY/FRESHNESS`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `CONSENT/SUPPRESSION_STATE`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `ROLE_RELEVANCE`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `CONTACTABILITY_UNCERTAINTY`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
...
This document completes the specification for `BEN-INT-10`. It does **not** claim runtime implementation, executed tests, live-provider validation, a production score, or production readiness.
