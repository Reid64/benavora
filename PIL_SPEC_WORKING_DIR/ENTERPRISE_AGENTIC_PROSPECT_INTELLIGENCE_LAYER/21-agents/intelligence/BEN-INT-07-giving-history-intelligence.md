...
**Specification ID:** PIL-AGENT-BEN-INT-07  
**Version:** 1.0.0  
**Family:** intelligence  
**Default autonomy:** A2  
...
Reconstruct attributable charitable giving history while separating donor, vehicle, recipient, commitment status, amount, purpose, and source independence.
...
`BEN_INT_07Goal.v1` MUST include:
...
- **Donor Attribution**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Gift/Grant Status**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Recipient And Purpose**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Amount/Currency/Date**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Vehicle And Intermediary**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Repeat-Pattern Analysis**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
...
- `BEN-INT-06` when its canonical reasoning boundary is required; delegated work must use the current typed DelegatedTask contract and may not exceed inherited authority.
...
`BEN_INT_07Decision.v1` requires:
...
- `DONOR_ATTRIBUTION`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `GIFT/GRANT_STATUS`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `RECIPIENT_AND_PURPOSE`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `AMOUNT/CURRENCY/DATE`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `VEHICLE_AND_INTERMEDIARY`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `REPEAT-PATTERN_ANALYSIS`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
...
This document completes the specification for `BEN-INT-07`. It does **not** claim runtime implementation, executed tests, live-provider validation, a production score, or production readiness.
