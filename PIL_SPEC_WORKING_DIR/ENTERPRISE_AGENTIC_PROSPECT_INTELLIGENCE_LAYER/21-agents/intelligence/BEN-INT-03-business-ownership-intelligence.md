...
**Specification ID:** PIL-AGENT-BEN-INT-03  
**Version:** 1.0.0  
**Family:** intelligence  
**Default autonomy:** A2  
...
Research documented business ownership, control, founder, partnership, and beneficial-interest evidence without converting company value into personal wealth.
...
`BEN_INT_03Goal.v1` MUST include:
...
- **Legal Entity Ownership**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Direct Versus Indirect Interests**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Control Versus Economics**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Ownership Intervals**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Transactions And Exits**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
- **Private-Company Uncertainty**: observe source-specific facts, alternatives, uncertainty, effective time, and evidence lineage.
...
`BEN_INT_03Decision.v1` requires:
...
- `LEGAL_ENTITY_OWNERSHIP`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `DIRECT_VERSUS_INDIRECT_INTERESTS`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `CONTROL_VERSUS_ECONOMICS`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `OWNERSHIP_INTERVALS`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `TRANSACTIONS_AND_EXITS`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
- `PRIVATE-COMPANY_UNCERTAINTY`: gold-set accuracy, negative-case safety, temporal semantics, evidence sufficiency, contradiction behavior, and calibrated abstention.
...
This document completes the specification for `BEN-INT-03`. It does **not** claim runtime implementation, executed tests, live-provider validation, a production score, or production readiness.
