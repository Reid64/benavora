...
exports.NAICS_CATEGORIES = exports.NAICS_FRIENDLY_LABELS = void 0;
exports.naicsLabel = naicsLabel;
/** NAICS code -> plain-English name shown on category chips and search results. */
exports.NAICS_FRIENDLY_LABELS = {
...
function naicsLabel(code) {
    return exports.NAICS_FRIENDLY_LABELS[code] ?? code;
}
