...
import type { DraftPrompt, DraftPromptContext } from "@/types/ai";

function formatAsk(min: number | null, max: number | null): string | null {
  const fmt = (n: number) =>
 ...
 */
export function buildDonationRequestPrompt(
