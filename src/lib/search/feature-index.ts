...
export const FEATURE_INDEX: FeatureIndexEntry[] = [
  ...
  },
  {
    ...
    description:
      "The complete 10-section Knowledge Base editor feeding AI drafting, probability scoring, and the Digital Twin.",
  ...
  },
  {
    ...
    route: "/intelligence-library",
    description: "Corpus of funded grant proposals across funding categories, kept for pattern reference.",
    keywords: ["funded proposals", "grant examples", "proposal corpus", "niaid", "nih reporter"],
    requiredRole: "viewer",
  },
  {
    label: "Agent Marketplace",
    route: "/agents/marketplace",
    description: "Browse and toggle autonomous agents registered on the platform, with run history and plan gating.",
    keywords: ["agent registry", "enable agent", "autonomous agents list"],
    requiredRole: "viewer",
  },
  {
    label: "Deadlines",
  ...
  },
  {
    label: "Intelligence",
    route: "/intelligence",
    description: "Intelligence hub: Digital Twin, Match Feed, Knowledge Engine, Gap Analyzer, Reputation, Disaster Response, and more.",
  ...
  },
  {
    ...
    description: "Organizational Digital Twin profile with a completeness score, feeding AI draft generation.",
    keywords: ["digital twin", "completeness score", "org twin"],
    requiredRole: "viewer",
  },
  {
    label: "Match Feed",
  ...
  },
  {
    ...
    keywords: ["knowledge gap", "narrative gap", "geographic mismatch", "funding gap analyzer"],
    requiredRole: "viewer",
  },
  {
    label: "Competitors",
  ...
  },
  {
    ...
    description: "AI semantic funder matching against your organization's mission and programs.",
    keywords: ["semantic funder matching", "ai match funders"],
    requiredRole: "viewer",
  },
  {
    label: "Reputation",
    route: "/intelligence/reputation",
    description: "Reputation monitoring for funders and contacts: severity-classified alerts, auto-monitor on add.",
    keywords: ["reputation monitor", "reputation alerts", "funder reputation"],
    requiredRole: "viewer",
  },
  {
  ...
  },
  {
    ...
    description: "AI donor intent monitoring for signals of corporate giving intent.",
    keywords: ["donor intent engine", "giving intent signals"],
    requiredRole: "viewer",
  },
  {
    ...
    description:
      "Force-directed graph of your organization's philanthropic relationship network, with a warm-introduction path finder between your org and a funder.",
    keywords: ["relationship graph", "path finder", "warm introduction", "network graph"],
    requiredRole: "viewer",
  },
  {
    label: "Strategic Advisor",
    route: "/intelligence/strategic-advisor",
    description: "AI strategic advisor command center synthesizing forecast, pipeline, and relationship data into recommendations.",
    keywords: ["strategic advisor", "ai advisor"],
    requiredRole: "viewer",
  },
  {
