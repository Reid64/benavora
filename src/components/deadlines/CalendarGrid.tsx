  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid grid-cols-7 border-b border-navy-300 bg-sidebar text-center text-xs font-medium text-white">
          {WEEKDAYS.map((day) => (
          ...
          {days.map((day) => {
            ...
            return (
              <div
                key={key}
                className={cn(
                  "min-h-[6.5rem] border-b border-r border-navy-300 p-1.5",
