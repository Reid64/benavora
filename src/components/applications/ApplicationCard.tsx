...
export function ApplicationCard({
  ...
  return (
    <div
      ...
      className={
        "group rounded-lg border border-border bg-white p-3 text-left shadow-sm transition hover:border-teal-300 hover:shadow focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 " +
