...
export function FoundationCard({
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-sm border border-slate-200 p-5 hover:shadow-md hover:border-[#00B4D8] transition-all cursor-pointer ${getAccentClass(foundation.name)}`}
    >
