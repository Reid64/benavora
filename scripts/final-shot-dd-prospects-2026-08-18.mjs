...
async function main() {
  ...
  await page.screenshot({ path: `smoke-test-output/AFTER-dd-prospects-resolved-2026-08-18.png`, fullPage: true });
  const bodyText = await page.locator("body").innerText();
  console.log("Contains 'No prospects yet':", bodyText.includes("No prospects yet"));
