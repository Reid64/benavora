...
- Name: e2e\critical-paths.spec.ts >> Critical paths >> 4. AutoApply engine page renders with no uncaught client-side error
- Location: e2e\critical-paths.spec.ts:228:7
